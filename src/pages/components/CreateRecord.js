...
export default function CreateRecord(id, name, phone, email, birthdate, grade, address, gender)
{
    ...
    post(`http://${ServerIP}/php/create.php?
    ...
    function(response) {
        if (response !== "created") {
            result.innerHTML = "Error Occured. Record has not been Created.";
        
        } else {
            result.style.color = "green";
            result.innerHTML = "Student Record has been Created";
        }
    });
}